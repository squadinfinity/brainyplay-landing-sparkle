              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <p className="text-xl text-gray-700 leading-relaxed">
                    Welcome to the <strong>Lumix</strong> family! We'll keep you updated on our progress and notify you as soon as we're ready to launch.
                  </p>
                </div>
      ...
      <div className="container mx-auto max-w-2xl relative z-10">
        <div className="text-center space-y-6 mb-12">
          ...
          <p className="text-xl text-gray-700 max-w-xl mx-auto leading-relaxed">
            Be the first to know when <strong>Lumix</strong> launches and get exclusive early access to transform your child's screen time!
          </p>
